      ...
      <div className="max-w-4xl mx-auto pt-10 px-5 xl:px-0">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-1">
            ...
            <h2 className="font-bold text-xl xl:text-3xl pl-3 text-gray-700 dark:text-white">{item.title || <Skeleton />}</h2>
          </div>
        ...
        <section className="my-8">
          ...
          <a href={item?.githubURL} className="underline text-blue-500 flex items-center gap-1 cursor-pointer">
