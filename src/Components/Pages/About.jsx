      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col-reverse xl:flex-row items-center xl:items-start justify-between px-4 xl:px-0">
          <div className="max-w-full xl:max-w-[50%]">
            ...
            <p className="my-6 text-sm xl:text-base">
              ...
              interactive user interfaces. Adept at utilizing TailwindCSS and
            ...
            <section>
              <h2 className="font-bold text-xl xl:text-2xl mb-6 dark:text-white">
                Usage
              </h2>
              <p>Tools, technologies and gadgets I use but not limited to.</p>

              <div className="my-10">
                <h3 className="font-bold text-lg xl:text-xl mb-3 dark:text-white">
                  Technologies
                </h3>
          ...
          <div className="mb-6 xl:mb-0 dark:text-white">
            <img
              src={me}
              alt=""
              className="bg-zinc-200 rounded-lg w-[250px] max-sm:w-[100%] lg:w-[500px]"
            />

            <div className=" flex items-center justify-between my-4">
              <Link
                to="resume"
                className="flex items-center justify-center gap-1 p-2 border-transparent border hover:border-zinc-200 cursor-pointer w-[90%] rounded-md dark:bg-zinc-800 dark:hover:border-zinc-600"
              >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="email flex items-center gap-1 cursor-pointer"
            >
              <svg
                fill="#3f3f46"
                xmlns="http://www.w3.org/2000/svg"
        ...
        <section className="px-8 pt-10 xl:px-0">
          ...
          <p className="mt-3 mb-6">
            Here are my socials once again!
          </p>

          <section className="socials flex-wrap max-w-full xl:max-w-[80%] pt-10 text-sm">
            <a
              href="https://twitter.com/sofelajoshua"
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-2 px-6 py-2 border border-gray-200 rounded-md hover:bg-zinc-200 dark:bg-zinc-800 dark:border-gray-800"
            >
              ...
              <div className="text-zinc-600 font-medium dark:text-white">
                Twitter
              </div>
            </a>
