      ...
      <footer className="border border-t-zinc-200 mt-16 dark:border-gray-800">
        <div className="flex flex-col xl:flex-row items-center justify-between text-zinc-700 dark:text-white max-w-7xl mx-auto pt-8 pb-32 text-sm px-8 xl:px-0">
          <div className="flex flex-col xl:flex-row items-center">
            ...
            <div className="flex items-center gap-2 ml-2 my-3 xl:my-0">
              ...
              <a href="#" target="_blank" rel="noreferrer" className="flex items-center gap-1">
                <img src="/tailwind_img.jpg" alt="tailwind icon" className="w-[20px]" />
                <span>Tailwindcss</span>
              </a>
  
              <a href="#" target="_blank" rel="noreferrer" className="flex items-center gap-1">
                <img src="/udemy_img.png" alt="udemy icon" className="w-[20px]" />
                <span>Netlify</span>
              </a>
            </div>
          </div>
