    ...
    <nav className="border border-zinc-200 relative dark:border-gray-800">
      <div className="flex items-center justify-between py-4 lg:py-8 max-w-7xl mx-auto px-8 xl:px-0">
        ...
        <div className="flex items-center gap-2">
          <div className="border border-zinc-200 rounded-full p-2 w-[40px] h-[40px] cursor-pointer relative flex items-center gap-3 dark:border-gray-800" onClick={toggleBackground}>
