    ...
    <nav className="border border-zinc-200 relative dark:border-gray-800">
      <div className="flex items-center justify-between py-4 lg:py-8 max-w-7xl mx-auto px-8 xl:px-0">
        ...
        <div className="flex items-center gap-2">
          <div className="border border-zinc-200 rounded-full p-2 max-sm:p-5 w-[40px] h-[40px] cursor-pointer relative flex items-center gap-3 dark:border-gray-800" onClick={toggleBackground}>
            <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24d" viewBox="0 0 50 50" className="sun absolute top-0 left-[7px]">
