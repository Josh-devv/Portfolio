...
export default function Hero() {
      ...
      <div className="max-w-7xl pt-20 max-sm:pt-[16] flex flex-col md:flex-row items-center justify-between mx-auto gap-8 px-8 xl:px-0">
        <section className="md:w-[50%] w-auto">
          ...
          <section className="flex flex-wrap gap-4">
            ...
            <Link to="/about/resume"  className="tech_stack flex items-center gap-1 border-b border-zinc-200 cursor-pointer pb-1">
  ...
  <rect x="100" y="300" width="200" height="200" stroke="#795548" stroke-width="2" fill="none" />
  <rect x="300" y="300" width="200" height="200" stroke="#FF9800" stroke-width="2" fill="none" />
  <rect x="500" y="300" width="200" height="200" stroke="#9C27B0" stroke-width="2" fill="none" />
</svg>
